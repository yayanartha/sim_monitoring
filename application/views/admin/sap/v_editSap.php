<div class="modal fade" id="modal_editSap" tabindex="-1" role="dialog" aria-labelledby="modal_editSapLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="modal_editSapLabel">Ubah Data SAP</h4>
      </div>
      <div class="modal-body">
        <?php 
        $attributes = array('name' => 'formEditSap'); 
        echo form_open_multipart('admin/sap/editSap', $attributes);?>
          <br>
